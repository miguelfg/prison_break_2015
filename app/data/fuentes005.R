...
my_px_object <- read.px("./varios/02006.px")
summary(my_px_object)
ine_02006   <- as.data.frame(my_px_object)
summary(ine_02006)

# Series por Comunidad Autonoma. Población (españoles/extranjeros) por edad 
# (año a año), sexo y año  - 02003.px

my_px_object <- read.px("./varios/02003.px")
summary(my_px_object)
ine_02003   <- as.data.frame(my_px_object)
summary(ine_02003)

# Series por Comunidad Autonoma. Población extranjera por Nacionalidad, sexo y 
# año  - 02005.px

my_px_object <- read.px("./varios/02005.px")
summary(my_px_object)
ine_02005   <- as.data.frame(my_px_object)
summary(ine_02005)
...
# save(ine_02005, file="ine_02005.RData")
